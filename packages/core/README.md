...
The headless engine behind [Moka](https://github.com/mokalabs/moka): providers for any LLM, an MCP client manager (stdio / Streamable HTTP / SSE), Agent Skills, a streaming tool loop, and an event bus that records every step.
